...
const StatsSection = () => {
  return (
    <div className="w-full flex flex-col gap-y-12 items-center  md:flex-row md:gap-x-10 md:pr-16">
      ...
      <div className="w-full md:w-[50%]">
        <TextWithIcon
          ...
          mainText={
            <div className="text-[31px] font-medium drop-shadow-text text-left md:text-right">
              Watch what the whales are doing
            </div>
          }
          className="text-white items-start md:items-end "
          subText={
            <div className="font-500 text-[16px] text-sub text-left md:text-right">
